<template>
  <q-layout view="lHr lpR fFf">
    ...
    <q-header bordered class="bg-white text-black">
      <q-toolbar>
        ...
        <q-toolbar-title class="text-weight-bold">
          ...
          <q-icon class="q-pa-md lt-md header-icon" color="primary" size="sm" name="fas fa-dove" />
        </q-toolbar-title>
      </q-toolbar>
    </q-header>

    <q-drawer show-if-above v-model="left" side="left" bordered :width="283">
      <q-icon class="q-pa-md" color="primary" size="lg" name="fas fa-dove" />
    ...
    <q-drawer show-if-above v-model="right" side="right" bordered>
      <q-input rounded outlined dense placeholder="Search Twitter" class="q-ma-md">
      ...
      <q-list padding separator>
        ...
        <q-item class="q-pa-md">
          ...
          <q-item-section side top>
            <q-item-label caption>7 min ago</q-item-label>
          </q-item-section>
        </q-item>

        <q-item class="q-pa-md">
          <q-item-section>
            <q-item-label overline class="text-grey">Games</q-item-label>
            <q-item-label class="text-weight-bold">Something amazing happened!</q-item-label>
            <q-item-label caption>Secondary line text. Lorem ipsum dolor sit amet, consectetur adipiscit elit.</q-item-label>
          </q-item-section>

          <q-item-section side top>
            <q-item-label caption>12 min ago</q-item-label>
          </q-item-section>
        </q-item>
      </q-list>
    </q-drawer>
